...
from .graph_utils import data_loader, sparse_mx_to_torch_sparse_tensor
...
class Sampler:
    ...
    def __init__(self, dataset, data_path="/home/tkw5356/_gcflow/data/graph_datasets", task_type="semi"):
        ...
        self.idx_remain_torch = torch.LongTensor(self.idx_remain)
